...
import { retrieveData, retrieveDataTest, retrieveDataGraph, retrieveDataMap } from './controls.js'
...
router.get('/api/test', retrieveDataGraph)
router.get('/test', retrieveDataTest)
router.get('/api/map', retrieveDataMap)
